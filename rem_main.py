...
# Main function file
def main():
    mean_att_loss = (prob_att_win_big_3v3 * 0) + (prob_att_win_small_3v3 * 1) + (prob_def_win_small_3v3 * 2) + (
                prob_def_win_big_3v3 * 3)
    mean_def_loss = (prob_att_win_big_3v3 * 3) + (prob_att_win_small_3v3 * 2) + (prob_def_win_small_3v3 * 1) + (
                prob_def_win_big_3v3 * 0)
    print(mean_att_loss, mean_def_loss)
    ...
    print(var_att, var_def)
    print(np.sqrt(var_att), np.sqrt(var_def))
    return 0
